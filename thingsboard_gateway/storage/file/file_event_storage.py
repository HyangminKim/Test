...
import storage.file.event_storage_reader as EventStorageReader
# from thingsboard_gateway.storage.file.event_storage_writer import DataFileCountError, EventStorageWriter
from thingsboard_gateway.storage.file.event_storage_writer import DataFileCountError
import storage.file.event_storage_writer as  EventStorageWriter
...
class FileEventStorage(EventStorage):
    def __init__(self, config):
        ...
        self.__writer = EventStorageWriter.EventStorageWriter(self.event_storage_files, self.settings)
        self.__reader = EventStorageReader.EventStorageReader(self.event_storage_files, self.settings)
