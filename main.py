...
client1 = minimalmodbus.Instrument('/dev/ttyTHS0', 1, debug=True)  # port name, slave address (in decimal)
...
client1.address         = 2        # this is the slave address number
...
while True:
    ...
    # temperatures = client1.read_registers(2, 1)  # Registernumber, number of decimals
    # temperatures = client1.read_registers(248, 4)  # Registernumber, number of decimals
    temperatures = client1.read_register(1,1)  # Registernumber, number of decimals
    print()
